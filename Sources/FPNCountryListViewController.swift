...
open class FPNCountryListViewController: UITableViewController, UISearchResultsUpdating, UISearchControllerDelegate {
    ...
    func registerForListCell(){
        let nib = UINib(nibName: "CountryListTableViewCell", bundle: Bundle.FlagPhoneNumber())
        tableView.register(nib, forCellReuseIdentifier: "CountryListTableViewCell")
    }
    ...
    override open func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.setup(country, showPhoneCode: showCountryPhoneCode)
