...
FlagPhoneNumber is available through [SPM](https://github.com/apple/swift-package-manager), [CocoaPods](http://cocoapods.org) and [Carthage](https://github.com/Carthage/Carthage). 
